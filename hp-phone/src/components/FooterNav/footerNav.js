...
import styles from './footerNav.module.less';
      ...
      <div className={styles.bottom}>
        <ul>
          {this.state.nav.map((item, index) => {
            return <li key={'main' + index} className={item.link === this.props.location.pathname ? styles.navIcon + ' ' + styles.list : styles.list}>
