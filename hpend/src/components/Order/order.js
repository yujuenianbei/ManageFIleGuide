    ...
    state = {
        ...
        defaultColumns: [
            ...
            },
            {
                ...
                width: 130,
                render: (text, record) => {
                    return <img className={styles.productBreImg} src={record.productImg.split('http').length > 1 ? record.productImg : 'http://localhost:3004/static/img/' + record.productImg} title={record.productName} />
                },
            },
            // {
            //     title: '配置参数',
