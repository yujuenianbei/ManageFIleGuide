...
const FIELD = _graphql.Kind.FIELD,
      ...
      INLINE_FRAGMENT = _graphql.Kind.INLINE_FRAGMENT;
  ...
  const projection = (selections || []).reduce((res, ast) => {
    switch (ast.kind) {
      case FIELD:
        {
          ...
          if (res[value]) {
            res[value] = (0, _deepmerge2.default)(res[value], getProjectionFromASTquery(context, ast) || true);
          } else {
      ...
      case INLINE_FRAGMENT:
        return (0, _deepmerge2.default)(res, getProjectionFromASTquery(context, ast));
      case FRAGMENT_SPREAD:
        return (0, _deepmerge2.default)(res, getProjectionFromASTquery(context, context.fragments[ast.name.value]));
      default:
...
function extendByFieldProjection(returnType, projection) {
  ...
  Object.keys(proj).forEach(key => {
    ...
    if (field.projection) proj = (0, _deepmerge2.default)(proj, field.projection);
