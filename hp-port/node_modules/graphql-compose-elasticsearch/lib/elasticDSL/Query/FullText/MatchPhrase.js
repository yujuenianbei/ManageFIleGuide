...
function getMatchPhraseITC() {
  var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

  var name = (0, _utils.getTypeName)('QueryMatchPhrase', opts);
  ...
  var subName = (0, _utils.getTypeName)('QueryMatchPhraseSettings', opts);
  var fields = (0, _FieldNames.getAnalyzedAsFieldConfigMap)(opts, (0, _utils.getOrSetType)(subName, function () {
