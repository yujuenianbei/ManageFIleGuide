...
function getFunctionScoreITC() {
  var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

  var name = (0, _utils.getTypeName)('QueryFunctionScore', opts);
  ...
  var RandomScoreType = _graphqlCompose.InputTypeComposer.create({
...
function prepareFunctionScoreInResolve(function_score, fieldMap) {
  ...
  if (Array.isArray(function_score.functions)) {
    function_score.functions = function_score.functions.map(function (func) {
      if (func.filter) {
