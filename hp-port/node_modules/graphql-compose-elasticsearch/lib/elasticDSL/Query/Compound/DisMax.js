...
function getDisMaxITC() {
  var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

  var name = (0, _utils.getTypeName)('QueryDisMax', opts);
...
function prepareDisMaxResolve(dis_max, fieldMap) {
  if (Array.isArray(dis_max.queries)) {
    dis_max.queries = dis_max.queries.map(function (query) {
      return (0, _Query.prepareQueryInResolve)(query, fieldMap);
    });
  }
