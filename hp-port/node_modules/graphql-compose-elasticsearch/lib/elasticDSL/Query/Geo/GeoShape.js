...
function getGeoShapeITC() {
  var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

  var name = (0, _utils.getTypeName)('QueryGeoShape', opts);
  ...
  var subName = (0, _utils.getTypeName)('QueryGeoShapeSettings', opts);
  var fields = (0, _FieldNames.getGeoShapeAsFieldConfigMap)(opts, (0, _utils.getOrSetType)(subName, function () {
