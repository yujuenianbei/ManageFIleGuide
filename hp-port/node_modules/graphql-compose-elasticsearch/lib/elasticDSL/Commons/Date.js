...
function getDateRangeITC() {
  var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

  var name = (0, _utils.getTypeName)('DateRange', opts);
  var description = (0, _utils.desc)(`Date range where \`from\` value includes and \`to\` value excludes.`);
