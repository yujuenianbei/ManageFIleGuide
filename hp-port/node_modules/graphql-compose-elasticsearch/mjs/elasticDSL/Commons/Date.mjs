...
export function getDateRangeITC(opts = {}) {
...
export function getDateFormatFC(opts = {}) {
  return {
    type: 'String',
    description: desc(`
...
export function getDateIntervalFC(opts = {}) {
  return {
    type: 'String',
    description: desc(`
...
export function getDateMathFC(opts = {}) {
  return {
    type: 'String',
    description: desc(`
...
export function getDateTimeZoneFC(opts = {}) {
  return {
    type: 'String',
    description: desc(`
